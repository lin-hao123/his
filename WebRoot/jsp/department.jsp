      ...
      <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
          <ul class="nav nav-sidebar">
            <li class="active"><a href="${pageContext.request.contextPath}/department/list">科室管理<span class="sr-only">(current)</span></a></li>
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          <form class="form-inline" action="${pageContext.request.contextPath}/department/add" method="post" style="float: right">
            <span style="color: red;font-weight: bold">${msg}</span>
            <input type="text" name="name" class="form-control" required autofocus placeholder="请输入科室名称" />
            <input type="submit" value="新增" class="btn btn-primary" />
          </form>
          <h2 class="sub-header">科室管理</h2>
          <div class="table-responsive">
			...
			<div style="float: right">
				...
				<form id="pageQuery" action="${pageContext.request.contextPath}/department/list" method="post">
				...
				<script type="text/javascript">
					...
					function checkForm(){
						//document.getElementById("pageQuery").submit();
						$("#pageQuery").submit(); 
					}
				</script>
			</div>

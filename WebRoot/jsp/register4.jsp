      ...
      <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            ...
            <table class="table table-striped">
              ...
              <c:forEach var="v" items="${list}" >
				<tr>
				  ...
				  <c:choose>
					<c:when test="${v.ispaid==1}">
				  <td><a href="${pageContext.request.contextPath}/prescription/list2/${v.id==null?'&nbsp;':v.id }">处方</a></td>
					</c:when>
					<c:otherwise>
				  <td>暂无</td>
					</c:otherwise>
          ...
          <div style="float: right">
			...
			<form id="pageQuery" action="${pageContext.request.contextPath}/register/list4" method="post">

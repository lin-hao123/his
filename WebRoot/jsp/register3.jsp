      ...
      <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
          <ul class="nav nav-sidebar">
            <li class="active"><a href="${pageContext.request.contextPath}/register/list3">处方管理<span class="sr-only">(current)</span></a></li>
          </ul>
        </div>
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          <h2 class="sub-header">处方管理</h2>
            ...
            <table class="table table-striped">
              ...
              <c:forEach var="v" items="${list}" >
				<tr>
				  ...
				  <td><a href="${pageContext.request.contextPath}/prescription/list/${v.id==null?'&nbsp;':v.id }">处方</a></td>
				</tr>
			  </c:forEach>
              </tbody>
            </table>
          ...
          <div style="float: right">
			...
			<form id="pageQuery" action="${pageContext.request.contextPath}/register/list3" method="post">
